...
contract Election {
    ...
    event uservoteLog(uint _candidateId,address _voterAddress);
    ...
    constructor() public {
         addCandidate("Eastern bluebird","Eastern");
         addCandidate("Pigeons","Pigeons");
         addCandidate("Parrot","Parrot");
         addCandidate("Angry Birds","AngryBirds");
    }
    ...
    function addVoterData(address _Address, string _voterElectionId,string _FName,string _LName, uint _Gender) public {
